...
The YAML file contains the configuration of the **controller manager** and other controllers (we are using a differential robot controller, other controllers are available [here](https://github.com/ros-controls/ros2_controllers/blob/master/doc/controllers_index.rst)).
